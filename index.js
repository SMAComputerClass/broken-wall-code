...
var uncleUbSound = new Audio("carl sound.wav");
...
function processSquare(pos) {
  ...
  switch (squareStatus) {
    ...
    case SQ_STATUS_WALL:
      ...
      squares[i].innerHTML = "<img src= 'adlani grass.jpg'>";
      break;
...
function getMediumTreasure() {
  ...
  var i;
  for (i = 0; i < lootAmount; i++) {
    var lootNumber = Math.floor((Math.random() * 14 + 1));
    switch (lootNumber) {
      case 1:
